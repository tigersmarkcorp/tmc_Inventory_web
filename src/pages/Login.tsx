    ...
    <div className="min-h-screen w-full flex bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-12 z-10">
          ...
          >
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-hero text-primary-foreground font-bold text-xl shadow-elegant">
              TM
            </div>
            <div>
              <h2 className="text-xl font-bold text-foreground">TIGER'S MARK</h2>
              <p className="text-xs text-muted-foreground font-medium tracking-wider">CORPORATION</p>
            </div>
          </motion.div>
      ...
      <div className="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-6 sm:p-12">
        ...
        >
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-hero text-primary-foreground font-bold text-lg shadow-elegant">
              TM
            </div>
            <div>
              <h2 className="text-lg font-bold text-foreground">TIGER'S MARK</h2>
