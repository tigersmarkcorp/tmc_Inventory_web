...
import { Package, AlertCircle, PackageOpen, LogOut, Users, Activity } from "lucide-react";
              ...
              <CardContent>
                {weeklyProductivity.length > 0 ? (
                  <div className="space-y-6">
                    <ResponsiveContainer width="100%" height={250}>
                      <BarChart data={weeklyProductivity}>
                        ...
                        />
                        <Legend />
                        <Bar dataKey="adds" name="Added" fill="hsl(142, 76%, 36%)" radius={[4, 4, 0, 0]} />
                        <Bar dataKey="updates" name="Updated" fill="hsl(217, 91%, 60%)" radius={[4, 4, 0, 0]} />
                        <Bar dataKey="deletes" name="Deleted" fill="hsl(var(--destructive))" radius={[4, 4, 0, 0]} />
                      </BarChart>
                    </ResponsiveContainer>
                      ...
                      {weeklyProductivity.map((user: any, index: number) => (
                        <div key={index} className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
                          ...
                          <div className="text-right">
                            <p className="text-lg font-bold text-primary">{user.actions}</p>
                  ...
                  <div className="flex flex-col items-center justify-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">Start managing inventory to see productivity stats</p>
                  </div>
                )}
              </CardContent>
            </Card>
